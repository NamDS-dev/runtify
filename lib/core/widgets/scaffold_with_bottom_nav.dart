...
// 메인 탭(홈/러닝/크루/랭킹) + 리워드(FeatureFlags.rewardEnabled 시) 공통 BottomNav 제공
class ScaffoldWithBottomNav extends StatelessWidget {
  ...
  // 현재 경로 문자열 → 탭 인덱스 변환
  // 탭 순서: 0=홈, 1=러닝, 2=크루, 3=랭킹, [4=리워드 (플래그 ON 시)]
  int get _currentIndex {
    ...
    if (FeatureFlags.rewardEnabled && location.startsWith('/reward')) return 4;
    return 0; // /home 기본값
  }
        ...
        onTap: (index) {
          switch (index) {
            ...
            case 3:
              context.go('/ranking');
            case 4:
              if (FeatureFlags.rewardEnabled) context.go('/reward');
          }
        },
        items: [
